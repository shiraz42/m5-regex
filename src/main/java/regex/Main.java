...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        // Handle null safely: null is not a valid password.
        if (str == null) {
            return false;
        }
    ...
    public static List<String> extractEmails(String str) {
        // Handle null safely: treat as no emails.
        if (str == null) {
            return new ArrayList<>();
        }

        // At least one character before '@', then "@mail.utoronto.ca" or "@utoronto.ca"
    ...
    public static boolean checkForDoubles(String str) {
        // Handle null safely: no doubles if there is no string.
        if (str == null) {
            return false;
        }
        // Any string that has the same A–Z letter at least twice.
